    ...
    return (
        <div className="px-6 py-5 space-y-4">
            <div className="flex justify-between">
                <img
                    className="rounded-full w-16 h-16 shadow-md border border-violet-500"
                    src={pp.src}
                    alt="A Photo of Chris Walker." />
                <div className="w-full mt-2">
                    <h1 className="text-gray-200 text-lg mx-4 border-b border-gray-500 mb-1.5">
                        Chris Walker
                    </h1>
                </div>
            ...
            <a href="https://github.com/WhatFor" className="group flex shadow items-center rounded px-2 py-3 bg-indigo-600 hover:bg-indigo-700">
